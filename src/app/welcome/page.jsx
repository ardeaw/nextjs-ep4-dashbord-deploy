...
function WelcomePage() {
  ...
  //ถ้าไม่มี session ก็คือไม่ได้ login เข้ามา ให้ redirect ไปหน้า login
      ...
      <div className="flex-grow">
        <div className="container mx-auto shadow-xl my-10 p-10 rounded-xl">
          <div className="flex justify-between">
            ...
            <div>
              <Link
                href="/create" className="bg-green-500 text-white border py-2 px-3 rounded-md text-lg my-2">
                Create Post
              </Link>
            </div>
          </div>
