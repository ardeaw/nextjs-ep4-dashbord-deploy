        ...
        <div className="container mx-auto">
          <div className="flex mt-10">
            ...
            <div className="p-10">
              ...
              <p>A list of posts retrieved from a MogoDB database</p>
                ...
                <table className="text-left rounded-md mt-3 table-fixed w-full">
                  <thead>
                    <tr className="bg-gray-400">
                      ...
                      <th className="p-5">Post Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {/* ดึง state "allPostsData" มา รับค่า "val" มา */}
                      ...
                      <tr key={val._id}>
                        ...
                        <td className="p-5">
                          <Link
                            ...
                            href={`/admin/posts/edit/${val._id}`}>Edit
                          </Link>
