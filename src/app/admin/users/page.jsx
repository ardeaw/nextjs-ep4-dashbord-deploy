            ...
            <div className='container mx-auto'>
                <div className='flex mt-10'>
                    ...
                    <div className='p-10'>
                        ...
                        <p>A list of users retrieved from a MogoDB database</p>
                            ...
                            <table className='text-left rounded-md mt-3 table-fixed w-full'>
                                ...
                                <tbody>
                                    {allUsersData?.map(val => (
                                        <tr key={val._id} className='bg-gray-100 border-b border-gray-200'>
                                            <td className='p-5'>{val._id}</td>
                                            <td className='p-5'>{val.name}</td>
                                            <td className='p-5'>{val.email}</td>
                                            <td className='p-5'>{val.role}</td>
                                            <td className='p-5'>
                                                <Link className='bg-gray-500 text-white border py-2 px-3 rounded text-lg my-2' href={`/admin/users/edit/${val._id}`}>Edit
                                                </Link>
